...
RUNNING ONE TEST
  Tests are .exe files, for instance 4_MP_NO_TSO_DSB_1_2.exe, run it by './4_MP_NO_TSO_DSB_1_2.exe'
...
RUNNING OPTIONS
  ...
  -s <n> one run operates on arrays of size <n>, default 100000000.
  -r <n> number of runs, default 10.

  For more options see for instance './4_MP_NO_TSO_DSB_1_2.exe -help' and litmus documentation
