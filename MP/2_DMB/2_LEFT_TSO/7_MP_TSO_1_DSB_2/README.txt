...
RUNNING ONE TEST
  Tests are .exe files, for instance 3_MP_NO_TSO_DSB_2.exe, run it by './3_MP_NO_TSO_DSB_2.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './3_MP_NO_TSO_DSB_2.exe -help' and litmus documentation
