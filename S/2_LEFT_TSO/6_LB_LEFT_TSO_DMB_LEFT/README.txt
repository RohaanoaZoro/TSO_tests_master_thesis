Tests produced by litmus for architecture AArch64 on MacOs 
...
RUNNING ONE TEST
  Tests are .exe files, for instance X.exe, run it by './X.exe'
...
RUNNING OPTIONS
  ...
  -s <n> one run operates on arrays of size <n>, default 10000000.
  -r <n> number of runs, default 10.

  For more options see for instance './X.exe -help' and litmus documentation
